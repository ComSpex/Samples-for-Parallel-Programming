...
namespace Sudoku
{
	...
	internal static class ResourceHelper
	{
		...
		private const string _stringsResourceFileName = "Sudoku.Strings";
		...
		static ResourceHelper()
		{
			...
			_boardBackgroundImage = GetResourceImageWithAlphaBlending("Sudoku.Images.BoardBackground.png");
			_boardImage = GetResourceImageWithAlphaBlending("Sudoku.Images.Board.png");

			// Get the active and hint cell images
			_cellActiveSquare = GetResourceImageWithAlphaBlending("Sudoku.Images.CellActiveSquare.png");
			_cellActiveUpperLeft = GetResourceImageWithAlphaBlending("Sudoku.Images.CellActiveUpperLeft.png");
			_cellActiveUpperRight = GetResourceImageWithAlphaBlending("Sudoku.Images.CellActiveUpperRight.png");
			_cellActiveLowerLeft = GetResourceImageWithAlphaBlending("Sudoku.Images.CellActiveLowerLeft.png");
			_cellActiveLowerRight = GetResourceImageWithAlphaBlending("Sudoku.Images.CellActiveLowerRight.png");
			_cellHintSquare = GetResourceImageWithAlphaBlending("Sudoku.Images.CellHintSquare.png");
			_cellHintUpperLeft = GetResourceImageWithAlphaBlending("Sudoku.Images.CellHintUpperLeft.png");
			_cellHintUpperRight = GetResourceImageWithAlphaBlending("Sudoku.Images.CellHintUpperRight.png");
			_cellHintLowerLeft = GetResourceImageWithAlphaBlending("Sudoku.Images.CellHintLowerLeft.png");
			_cellHintLowerRight = GetResourceImageWithAlphaBlending("Sudoku.Images.CellHintLowerRight.png");

			// Get the form button images 
			_buttonShadow = GetResourceImageWithAlphaBlending("Sudoku.Images.ButtonShadow.png");
			_buttonCheckedImage = GetResourceImageWithAlphaBlending("Sudoku.Images.ButtonChecked.png");
			_buttonUncheckedImage = GetResourceImageWithAlphaBlending("Sudoku.Images.ButtonUnchecked.png");
			_buttonHighlightedImage = GetResourceImageWithAlphaBlending("Sudoku.Images.ButtonHighlighted.png");
			_optionsImage = GetResourceImageWithAlphaBlending("Sudoku.Images.Options.png");
			_undoImage = GetResourceImageWithAlphaBlending("Sudoku.Images.Undo.png");
			_newPuzzleImage = GetResourceImageWithAlphaBlending("Sudoku.Images.New.png");

			// Get new puzzle dialog images
			_newPuzzleBackground = GetResourceImageWithAlphaBlending("Sudoku.Images.NewPuzzleBackground.png");
			_newPuzzleItemChecked = GetResourceImageWithAlphaBlending("Sudoku.Images.NewPuzzleItemChecked.png");
			_newPuzzleItemUnchecked = GetResourceImageWithAlphaBlending("Sudoku.Images.NewPuzzleItemUnchecked.png");
			_newPuzzleItemHighlighted = GetResourceImageWithAlphaBlending("Sudoku.Images.NewPuzzleItemHighlighted.png");
		}
