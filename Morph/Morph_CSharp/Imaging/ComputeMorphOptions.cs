...
namespace ParallelMorph {
	...
	public class ComputeMorphOptions {
		...
		public int NumberOfOutputFrames {
			...
			set {
				if(value<3)
					throw new ArgumentOutOfRangeException("NumberOfFrames",value,"There must be at least three output frames.");
		...
		public double ConstA {
			...
			set {
				if(value<0)
					throw new ArgumentOutOfRangeException("ConstA",value,"Must not be negative.");
				_constA=value;
			}
		}
		...
		public double ConstB {
			...
			set {
				if(value<0)
					throw new ArgumentOutOfRangeException("ConstB",value,"Must not be negative.");
				_constB=value;
			}
		}
		...
		public double ConstP {
			...
			set {
				if(value<0)
					throw new ArgumentOutOfRangeException("ConstP",value,"Must not be negative.");
				_constP=value;
			}
		}
	}
