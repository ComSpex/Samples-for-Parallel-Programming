...
namespace DiningPhilosophers {
	...
	public partial class MainWindow:Window {
		...
		private const int NUM_PHILOSOPHERS = 30;
		...
		private void ConfigurePhilosophers() {
			const double rad = 250D;
			_philosophers=(from i in Enumerable.Range(0,NUM_PHILOSOPHERS) select new Ellipse { Height=rad/(NUM_PHILOSOPHERS/5),Width=rad/(NUM_PHILOSOPHERS/5),Fill=Brushes.Red,Stroke=Brushes.Black }).ToArray();
